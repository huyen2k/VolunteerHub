...
export default function ManagerDashboardPage() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // 2. CẬP NHẬT STATS
      if (statsData) {
        const totalVols = managerEvents.reduce(
          (acc, ev) => acc + (ev.volunteersRegistered || 0),
          0
        );
        ...
        setStats({
          ...
          approved:
            (statsData.totalEvents || 0) - (statsData.pendingEvents || 0),
      ...
      // --- SỰ KIỆN THU HÚT ---
      const attractiveList = approvedEvents
        .map((ev) => ({
          ...ev,
      ...
      setMaxAttractiveScore(
        attractiveList.length > 0
          ? Math.max(...attractiveList.map((e) => e.score), 1)
          : 1
      );
        ...
        <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="mt-1 text-muted-foreground">
                Tổng quan hoạt động và hiệu suất sự kiện của bạn
              </p>
            </div>
            <Button
              asChild
            ...
            >
              <Link to="/manager/events/create"> Tạo sự kiện mới</Link>
            </Button>
          </div>
          ...
          <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card
              ...
              onClick={() => navigateToEvents("happening")}
            >
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Card
              className="cursor-pointer hover:shadow-lg transition-all border-l-4 border-l-green-500 hover:-translate-y-1 bg-white"
              onClick={() => navigateToEvents("upcoming")}
            >
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Card
              className="cursor-pointer hover:shadow-lg transition-all border-l-4 border-l-purple-600 hover:-translate-y-1 bg-white"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="mt-1 flex items-center text-xs text-purple-600 font-medium bg-purple-50 px-2 py-0.5 rounded-full w-fit">
                      <Users className="h-3 w-3 mr-1" /> Tất cả sự kiện
                    </div>
                  </div>
                          ...
                          >
                            ...
                            <div className="flex flex-col gap-1.5">
                              <div className="flex items-center gap-2">
                                <Badge
                                  variant="outline"
                                  className="text-green-600 bg-green-50 border-green-200 px-2.5 py-0.5 text-xs font-normal rounded-full"
                                >
                                  Mới
                                </Badge>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {eventsWithNewPosts.length > 0 ? (
                    eventsWithNewPosts.map((item, idx) => (
                      <div
                        key={idx}
                    ...
                    <div className="text-center py-10 bg-white rounded-xl border border-dashed border-gray-200">
                      <p className="text-muted-foreground">
                        Chưa có bài thảo luận nổi bật nào.
                      </p>
                    </div>
                  )}
                </div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-2 h-1.5 w-full bg-gray-100 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${Math.min(
                                  (ev.score / maxAttractiveScore) * 100,
                                  100
                                )}%`,
                                minWidth: "5%",
                              }}
