...
import { Calendar, MapPin, Printer, Search, Users, Eye, Check, X, FileText, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function AdminEventsPage() {
  ...
  if (loading && page === 0 && events.length === 0) return <AdminLayout><div className="flex justify-center p-10"><LoadingSpinner /></div></AdminLayout>;
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div ref={printRef}>
              <div className="hidden print:block text-center mb-8 border-b-2 border-black pb-4 pt-4">
                ...
                <p className="italic">Trang {page + 1}/{totalPages} - Ngày xuất: {new Date().toLocaleDateString("vi-VN")}</p>
              </div>
                ...
                {filteredEvents.length === 0 ? (
                    ...
                    filteredEvents.map((event) => (
                        <Card key={event.id}
                          ...
                          {/* (Phần Card Content giữ nguyên như code cũ để tiết kiệm dòng hiển thị ở đây) */}
